...
def mk_node_column(to_from):  
    deck_dropdown = Select(*mk_dropdown('deck', list(deck_qs.keys())), name='deck', hx_get='/questions', hx_target=f'#questions_{to_from}')
...
def mk_tag_gui(): 
    ...
    submit_btn = Button("Update Connection", id='submit_btn', hx_post="/submit_tag_update", hx_target="#result", hx_include='#checkbox_form')
